...
- [](#StandardFlyable) that supports the [Flyable](#bluesky.protocols.Flyable) protocol for motion and trigger systems by composing a [](#FlyableLogic) instance
