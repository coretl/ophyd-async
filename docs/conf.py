...
obj_ignore = [
    ...
    "ophyd_async.epics.motor.MotorFlyCtx",
    "ophyd_async.epics.motor.MotorFlyableMovableLogic",
    "ophyd_async.epics.pmac._pmac_trajectory.PmacFlyCtx",
    ...
    "ophyd_async.tango.core._utils.T",
    "ophyd_async.tango.core._utils.P",
